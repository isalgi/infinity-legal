function AboutSection() {
  return (
    <section className="flex flex-col justify-center items-center px-20 py-0 w-full h-[648px] max-sm:px-5 max-sm:py-16 max-sm:h-auto">
      <div className="flex flex-col gap-5 max-w-[1264px]">
        ...
        <p className="text-base font-medium leading-5 text-white">
          ...
          velit sit amet ullamcorper. mollis, urna id rutrum sollicitudin, enim
          justo porta turpis, et finibus nibh est eget eros. Cras sit amet velit
          accumsan, volutpat metus id, bibendum urna. Duis rutrum condimentum
          tellus in viverra.
        </p>
